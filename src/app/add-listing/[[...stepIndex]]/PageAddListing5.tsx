      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            {renderRadio("Partyorganizing", "Allow", "Allow")}
            {renderRadio("Partyorganizing", "Charge", "Charge", true)}
          </div>
        </div>
        ...
        <div className="flow-root">
          <div className="-my-3 divide-y divide-neutral-100 dark:divide-neutral-800">
            ...
            {renderNoInclude("Do not wear shoes in the house")}
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between space-y-3 sm:space-y-0 sm:space-x-5">
          <Input className="!h-full" placeholder="ex. No smoking" />
