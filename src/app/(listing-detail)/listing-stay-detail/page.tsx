  ...
  const renderSection2 = () => {
    return (
      <div className="listingSection__wrap">
        ...
        <span>
          The Beach House in Collingwood offers panoramic lake views and features a range of amenities including an outdoor swimming pool, a bar, a shared lounge, a garden, and barbecue facilities. Guests can enjoy the convenience of complimentary WiFi throughout their stay.
        </span>
        <br /><br />
        <span>
          Every unit is equipped with a private bathroom complete with a bidet, hairdryer, and complimentary toiletries.
        </span>
        <br /><br />
        <span>
          Featuring a terrace, The Beach House in Collingwood provides guests with both bicycle and car rental services, allowing for delightful cycling experiences in the surrounding areas.
        </span>
      </div>
      </div>
    );
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 text-sm text-neutral-700 dark:text-neutral-300 ">
          {Amenities_demos.filter((_, i) => i < 12).map((item) => (
            <div key={item.name} className="flex items-center space-x-3">
              <i className={`text-3xl color-yellow-accent las ${item.icon}`}></i>
    ...
    return (
      <div className="listingSection__wrap">
        ...
        <div>
          ...
          <li>
            Commit to preserving the greenery and cleanliness of our surroundings by avoiding littering, refraining from stimulant use, and showing respect to those around us.
          </li>
          <li>Karaoke sessions should conclude by 11:30 PM.</li>
        </ul>
          </div>
        </div>
      </div>
