  ...
  return (
    <div>
      <div className="relative flex min-h-screen">
        ...
        {!showFullMapFixed && (
          <div
            className={`flex xl:hidden items-center justify-center fixed bottom-16 md:bottom-8 left-1/2 transform -translate-x-1/2 px-6 py-2 bg-primary-6000 hover:bg-primary-700 text-neutral-50 shadow-2xl rounded-full z-30  space-x-3 text-sm cursor-pointer`}
        ...
        >
          ...
          <div className="fixed xl:sticky top-0 xl:top-[88px] left-0 w-full h-full xl:h-[calc(100vh-88px)] rounded-md overflow-hidden">
            ...
            <GoogleMapReact
              defaultZoom={12}
              defaultCenter={{
                lat: DEMO_STAYS[0].lat,
                lng: DEMO_STAYS[0].lng
              }}
              bootstrapURLKeys={{
